...
from models import Estado, Municipio, Partido, CongresoElectoral, CoalicionEnum
...
def import_congresos(csv_file: str):
    ...
    with Session(engine) as session:
        for index, row in df.iterrows():
            ...
            # --- 2. Verificar o insertar Municipio (clave primaria compuesta) ---
            estado_id = id_estado
            ...
            # --- 4. Insertar el registro del Congreso Electoral ---
            año = int(row['Año'])
            votos = int(row['Votos'])
            ...
            # Crear el registro en CongresoElectoral
            congreso = CongresoElectoral(
                año=año,
                estado_id=estado_id,
                id_municipio=id_municipio,
        ...
        session.commit()
    print("Datos de congresos importados exitosamente.")

if __name__ == "__main__":
    # Ruta del CSV de congresos
    csv_file = "/home/barea/limpieza/congresos/{{cookiecutter.project_slug}}/data/final/datos_electorales_2015_2023.csv"
